...
package cn.com.easytaxi.book.view.scrollwheel;
...
/**
 * 搬家定制版WheelView
 * @ClassName: BjWheelView 
 * @Description: TODO
 * @author Brook Xu
 * @date 2015年4月18日 上午10:41:25 
 * @version 1.0
 */
public class BjWheelView extends View
{
    /** Scrolling duration */
     ...
     * Constructor
     */
    public BjWheelView(Context context, AttributeSet attrs, int defStyle)
    {
     ...
     * Constructor
     */
    public BjWheelView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initData(context);
    }
     ...
     * Constructor
     */
    public BjWheelView(Context context)
    {
        super(context);
        initData(context);
    }
...
//        drawShadows(canvas);
    ...
    public interface OnWheelChangedListener
    {
         ...
         */
        void onChanged(BjWheelView wheel, int oldValue, int newValue);
    }
    ...
    public interface OnWheelScrollListener
    {
         ...
         *            the wheel view whose state has changed.
         */
        void onScrollingStarted(BjWheelView wheel);
         ...
         *            the wheel view whose state has changed.
         */
        void onScrollingFinished(BjWheelView wheel);
    }
