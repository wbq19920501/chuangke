...
public class AirportBookFragementActivity extends BaseFragementActivity implements ViewPager.OnPageChangeListener {
...
//	private RadioGroup radioGroup_choice;
	...
	private AirportBookPublishFragement bookPublishFragment;
//	private AirportBookListFragement bookListFragment;
...
//		radioGroup_choice = (RadioGroup)findViewById(R.id.tab);
		...
		bookPublishFragment = new AirportBookPublishFragement();
//		bookListFragment = new AirportBookListFragement();
...
//		fragments.add(1, bookListFragment);
	...
	public  void showRegistDialog(final Context context,String titile,String content,String btn1,String btn2,final String gotoClassName){
			 Callback<Object> okBtnCallback = new Callback<Object>() {
				...
				Dialog dialog = new CommonDialog(AirportBookFragementActivity.this, titile, content, btn1, btn2, R.layout.dlg_close,okBtnCallback,cancelBtnCallback);
				dialog.show();
		}
}
